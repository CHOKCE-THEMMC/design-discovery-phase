...
const About = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Notify all admins + send email via edge function (uses service role to bypass RLS)
      try {
        ...
        console.log('Edge function call failed:', emailErr);
      }
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-foreground">chunguobed5@gmail.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="p-2 bg-primary/10 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-foreground">+260768483190</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="p-2 bg-primary/10 rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-foreground">
                        <p>P O Box 99999</p>
                        <p>Plot 0612 Kanyanye Extension</p>
                        <p>Ndola, Zambia</p>
                      </div>
                    </div>
                  </div>
