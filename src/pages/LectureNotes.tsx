...
const LectureNotes = () => {
  ...
  const filteredNotes = useMemo(() => {
    return filterAndSortMaterials(notes, {
      searchQuery,
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        {/* Header */}
        <section className="bg-library-sage py-12 md:py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white/80 max-w-2xl">
              Access comprehensive lecture notes from various courses, compiled by 
              professors and teaching assistants to support your learning.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mb-6">
              <p className="text-sm text-muted-foreground">
                Showing {paginatedNotes.length} of {filteredNotes.length} lecture notes
              </p>
            </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">No lecture notes found</h3>
